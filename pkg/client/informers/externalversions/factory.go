...
type SharedInformerFactory interface {
	...
	Lvscontroller() lvscontroller.Interface
}

func (f *sharedInformerFactory) Lvscontroller() lvscontroller.Interface {
	return lvscontroller.New(f, f.namespace, f.tweakListOptions)
}
