...
import (
	...
	scheme "github.com/lvs-nginx-controller/pkg/client/clientset/versioned/scheme"
)
...
func newConfigurations(c *Lvs-nginx-controllerV1alpha1Client, namespace string) *configurations {
