...
type FakeConfigurations struct {
	Fake *FakeLvs-nginx-controllerV1alpha1
	ns     string
}

var configurationsResource = schema.GroupVersionResource{Group: "lvs-nginx-controller.k8s.io", Version: "v1alpha1", Resource: "configurations"}

var configurationsKind = schema.GroupVersionKind{Group: "lvs-nginx-controller.k8s.io", Version: "v1alpha1", Kind: "Configuration"}
